...
/**
 * LC.String.006 ZigZag Conversion
 * 
...
public class LC_006_Zigzag_Conversion {
	...
	public static String zigzagConvert(String s, int numRows) {
		...
		for (int i = 0; i < sb.length; i++) {
			sb[i] = new StringBuilder(""); // init every sb element **important
											// step!!!!
		}
		int incre = 1;
		int index = 0;
	...
	public static void main(String[] args) {
		System.out.println("Input  : " + "zigzag123");
		System.out.println("Output : " + zigzagConvert("zigzag123", 3));
