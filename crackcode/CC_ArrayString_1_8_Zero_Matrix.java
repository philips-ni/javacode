...
/**
 * CC.ArrayString.1.8 Zero Matrix
 * 
 * Question : Given a boolean matrix, update it so that if any cell is true, all
 * the cells in that row and column are true.
 * 
 ...
 * 
 */
public class CC_ArrayString_1_8_Zero_Matrix {
